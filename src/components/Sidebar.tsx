...
const sidebarItems = [
  ...
  { href: "/rewards", icon: Coins, label: "View Rewards" },
      ...
      <nav className="h-full flex flex-col justify-between">
            ...
            <Link key={item.href} href={item.href} passHref>
              <Button 
                ...
                className={`w-full justify-start py-3 ${
                  pathname === item.href 
                    ? "bg-purple-100 text-purple-800"  // Purple for active state
                    : "text-gray-600 hover:bg-gray-100"
                }`} 
              >
                <item.icon className="mr-3 h-5 w-5 text-purple-600" />  {/* Icon color updated to purple */}
        ...
        <div className="p-4 border-t border-gray-200">
          <Link href="/settings" passHref>
            ...
            >
              <Settings className="mr-3 h-5 w-5 text-purple-600" />  {/* Icon color updated to purple */}
